...
import { TreeContext } from '../components/christmas/types';
import Experience from '../components/christmas/Experience';
import GestureInput from '../components/christmas/GestureInput';
import TechEffects from '../components/christmas/TechEffects';
import { AnimatePresence, motion } from 'framer-motion';
import "../styles/ChristmasPage.css"

// --- 梦幻光标组件 ---
const DreamyCursor = ({ pointer, progress }) => {
...
const AppContent = () => {
    const { state, setState, webcamEnabled, setWebcamEnabled, pointer, hoverProgress, selectedPhotoUrl, setSelectedPhotoUrl, clickTrigger } = useContext(TreeContext);
...
const App = () => {
    ...
    const [rotationSpeed, setRotationSpeed] = useState(0.3); // 固定基础旋转速度
    const [rotationBoost, setRotationBoost] = useState(0); // 额外加速度
